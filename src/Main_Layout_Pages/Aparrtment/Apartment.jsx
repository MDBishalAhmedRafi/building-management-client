...
//   // Controlled values for actual query
...
//         <h2 className="text-3xl text-center md:text-4xl font-bold text-[#987b53]">
//           Discover Our Apartments
//         </h2>
//       <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
//         <h2 className="text-4xl  md:text-4xl font-bold text-[#987b53]">    
//         </h2>
...
//           {showFilter && (
//             <div className="absolute right-0 top-12 shadow-lg border rounded-md px-4 py-4 z-10 w-80">
//               <div className="mb-2">
...
//             >
//               <img
//                 src={apt.image || "https://via.placeholder.com/400x300"}
//                 alt={apt.name}
...
//               <div>
//                 <p className="text-gray-600 mb-2">{apt.description || "Modern luxury apartment."}</p>
...
//               <div className="mt-6">
//                 <button className="px-4 py-2 cursor-pointer bg-[#987b53] text-white rounded-md hover:bg-[#7b613c] transition duration-300">
//                   Agreement
//                 </button>
//               </div>
//             </div>
